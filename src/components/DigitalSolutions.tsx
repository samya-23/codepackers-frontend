        ...
        >
          {bsisprSolutions.map(({ icon: Icon, label }, i) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-2 sm:gap-4 p-3 sm:p-4 md:p-6 rounded-lg md:rounded-xl bg-white/70 border border-white/50 shadow-sm sm:shadow-md backdrop-blur-sm md:backdrop-blur-xl hover:shadow-lg sm:hover:shadow-2xl transition-all duration-300 hover:bg-white/80"
            >
