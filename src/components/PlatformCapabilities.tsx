              ...
              ([label, cards], slideIndex) => (
                <SwiperSlide key={label}>
                  <div className="flex flex-col items-center">
                    <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text mb-2">
                      {t(`capabilities.${label.toLowerCase()}.label`)}
                    </h2>
                    <p className="text-sm text-gray-600 mb-6">{t('capabilities.clickPrompt')}</p>
                      ...
                      {cards.map((cap, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <h3 className="text-xl font-semibold text-gray-800">{t(cap.title)}</h3>
                            <p className="text-sm text-gray-600 mt-2">{t(cap.short)}</p>
                          </motion.div>
                        );
                      })}
                    </div>
                  ...
                  <SwiperSlide key={i}>
                    <div>
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900">{t(cap.title)}</h3>
                      </div>
                      <p className="text-gray-700 mb-4">{t(cap.description)}</p>
